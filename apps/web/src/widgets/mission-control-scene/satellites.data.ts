...
export const MOCK_SATELLITES: Satellite[] = [
  {
    ...
    telemetry: { signalStrength: 92, battery: 88, temperature: 22, altitude: 550, healthScore: 94, latency: 45, anomalyLevel: 5 },
  },
  {
    ...
    telemetry: { signalStrength: 47, battery: 65, temperature: 38, altitude: 542, healthScore: 52, latency: 320, anomalyLevel: 28 },
  },
  {
